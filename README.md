...
5. Drag on the pad (X is always scale-quantized). While the pad is held it **owns the melodic lane** — the bass pattern ducks/stops (iMS-20-style: Kaoss performs the synth, not a second voice beside it):
